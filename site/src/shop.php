...
<head>
    <meta charset="utf-8">
    <title>SHOP LIST - GREENIFY</title>
...
<body>
    ...
    <div class="container-fluid">
        <!-- <div class="row px-xl-5"> -->
            ...
            <!-- Shop Product Start -->
            <div class="container-fluid">
            <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">SHOP LIST</span></h2>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                                    <div class="product-item bg-light mb-4">
                                        <div class="product-img position-relative overflow-hidden">
                                            ...
                                            <a class="btn btn-outline-dark btn-square" href="../process/process_add_to_cart.php?profile=<?php echo $profile ?>&id=<?php echo $arr['id']?>"><i class="fa fa-shopping-cart"></i></a>
                                                <!-- <a class="btn btn-outline-dark btn-square" href=""><i class="far fa-heart"></i></a> -->
                                                <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-sync-alt"></i></a>
                                                <a class="btn btn-outline-dark btn-square" href="detail.php?profile=<?php echo $profile ?>&id=<?php echo $arr['id']?>"><i class="fa fa-search"></i></a>
                                            </div>
                                        </div>
                    ...
                    <div class="col-12">
                        <nav>
                          <ul class="pagination justify-content-center ">
                            ...
                            <li class="page-item active "><a class="page-link bg-success" href="">1</a></li>
                            <li class="page-item "><a class="page-link text-dark" href="">2</a></li>
                            <li class="page-item"><a class="page-link text-dark"   href="">3</a></li>
                            <li class="page-item"><a class="page-link text-light bg-success" href="">Next</a></li>
                          </ul>
                        </nav>
                    </div>
                </div>
