          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="my-form">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="../../pages/manage-products/add_product.php">Add Product</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="../../pages/manage-products/edit_product.php">Edit Product</a>
                </li>
                <!-- <li class="nav-item">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">PRODUCT LISTING</h3>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="POST" action="process.php">
                      <?php  
                    ...
                    <h5 class="card-title mt-4">PHOTOS</h5>  
                      ...
                      <div class="row mt-5">
                        <div class="col-md-12 text-right">
                          <button name="submitted" value="Add Product" type="submit" class="btn btn-primary mr-2">Add Product</button>
                          <!-- <button class="btn btn-light">Cancel</button>  -->
                        </div>
                      </div>
                      <!-- <div class="row">
